...
namespace Demo_File_Handling_Operations
{
    public class Employee
    {
        ...
        public void AddEmployee(List<Employee> employees, string filePath)
        {
        ...
        public void DisplayMenu()
        {
            ...
            while (true) // Loop to keep displaying the menu until the user chooses to exit
            {
                ...
                Employee employee = new Employee(); // Create an instance of Employee to call non-static methods

                switch (choice)
                {
                    case 1:
                        employee.AddEmployee(Employees, "employees.txt");
                        break;
                    case 2:
